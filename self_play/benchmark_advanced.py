...
print("Alpha-Beta vs Greedy (basic) (2 rounds):")
benchmark(alpha_beta_select, greedy_select, rounds=2)

print("Alpha-Beta vs Aggressor (2 rounds):")
benchmark(alpha_beta_select, aggressor_select, rounds=2)

print("Alpha-Beta vs Spreader (2 rounds):")
benchmark(alpha_beta_select, spreader_select, rounds=2)

print("Alpha-Beta vs Banker (2 rounds):")
benchmark(alpha_beta_select, banker_select, rounds=2)
